...
@WebServlet(ApiNames.APIP7V1Path + ApiNames.AppRateHistoryAPI)
public class AppRateHistory extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        //Request
        String index = IndicesNames.APP_HISTORY;
        ...
        int nPrice = Integer.parseInt(Initiator.jedis0Common.hget("nPrice", ApiNames.AppRateHistoryAPI));
