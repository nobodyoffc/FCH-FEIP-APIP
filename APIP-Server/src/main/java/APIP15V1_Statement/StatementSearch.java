...
@WebServlet(APIP15V1Path +StatementSearchAPI)
public class StatementSearch extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        //Request
        String index = IndicesFEIP.StatementIndex;
        ...
        int nPrice = Integer.parseInt(Initiator.jedis0Common.hget("nPrice", StatementSearchAPI));
