...
@WebServlet(ApiNames.APIP16V1Path + ApiNames.TokenSearchAPI)
public class TokenSearch extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        //Set default sort.
        ArrayList<Sort> sort = Sort.makeSortList("lastHeight",false,"tokenId",true,null,null);
        ...
        List<Token> meetList;
        try {
            meetList = esRequest.doRequest(index,sort, Token.class);
            if(meetList==null){
                return;
            }
        } catch (Exception e) {
