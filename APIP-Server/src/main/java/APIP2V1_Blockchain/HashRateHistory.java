...
@WebServlet(ApiNames.APIP2V1Path + ApiNames.HashRateHistoryAPI)
public class HashRateHistory extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        Map<Long, String> hist = FreecashInfo.hashRateHistory(startTime, endTime, count, Initiator.esClient);

        if (Replier.checkAndResponseOtherError(hist == null, response, replier, "Failed to get hash rate history.", writer)) return;
