...
@WebServlet(ApiNames.APIP3V1Path + ApiNames.NoticeFeeHistoryAPI)
public class NoticeFeeHistory extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        int nPrice = Integer.parseInt(Initiator.jedis0Common.hget("nPrice", ApiNames.NoticeFeeHistoryAPI));
