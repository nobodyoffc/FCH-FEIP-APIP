...
@WebServlet(ApiNames.APIP6V1Path + ApiNames.ServiceOpHistoryAPI)
public class ServiceOpHistory extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        int nPrice = Integer.parseInt(Initiator.jedis0Common.hget("nPrice", ApiNames.ServiceOpHistoryAPI));
